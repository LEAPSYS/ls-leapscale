...
export default function Location({ onSelect }) {
    ...
    const centerContent = (
        <span style={{ textAlign: 'center', marginTop: 0 }}>Choose Location</span>
    );
                ...
                <div className="grid p-4">
                    {DUMMY_LOCATIONS.map((loc) => (
                        <div className="col-4" key={loc}>
                            <div
                                className={`text-center p-6 border-round-sm font-bold ${selected === loc ? 'bg-primary' : 'bg-tertiary border-2 border-dashed border-300'
                                    }`}
